		...
		if(E.first == VoteInput)
		{
			...
			case EActionKind::OpenLeaderboardCategory:
				if(pPlayer)
				{
					...
					pPlayer->Bw().m_CaptureTopCategory = A.A; // 0..3
			...
			case EActionKind::SetScoreMode:
				if(pPlayer)
				{
					pPlayer->Bw().m_ScoreDisplayMode = A.A;
