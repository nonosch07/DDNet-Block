#ifndef BLOCKWORLDS_BW_CHARACTER_H
#define BLOCKWORLDS_BW_CHARACTER_H
...
// All Blockworlds per-character state.
//
// CCharacter carries one CBwCharacter member plus a Bw() accessor; everything
// BW used to add to upstream's character.h lives here instead.
class CBwCharacter
{
public:
	...
	// Upstream keeps the inputs private; BW reads them for the AI bot and the
	// telekinesis command.
	...
	// returns a copy; CBwCharacter is a friend of CCharacter, so BW code that
	...
	// The Blockworlds game tiles: VIP gate, wayblock protection, random
...
#endif // BLOCKWORLDS_BW_CHARACTER_H
