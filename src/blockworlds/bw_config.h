#ifndef BLOCKWORLDS_BW_CONFIG_H
#define BLOCKWORLDS_BW_CONFIG_H

#include <engine/console.h>

// Float configuration variables owned by Blockworlds.
//
// Upstream's config system only knows int, colour and string variables. BW has
...
extern CBwConfig g_BwConfig;

#endif // BLOCKWORLDS_BW_CONFIG_H
