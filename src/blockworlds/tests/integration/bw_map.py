"""Writes a small DDNet map with the quad layers Blockworlds zones look for.
...
def build():
    """Returns the bytes of a map called bw_zones."""
    w = Writer()
...
if __name__ == "__main__":
    ...
    print(write(sys.argv[1] if len(sys.argv) > 1 else "bw_zones.map"))
