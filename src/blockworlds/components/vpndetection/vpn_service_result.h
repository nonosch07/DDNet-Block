#ifndef BLOCKWORLDS_COMPONENTS_VPNDETECTION_VPN_SERVICE_RESULT_H
#define BLOCKWORLDS_COMPONENTS_VPNDETECTION_VPN_SERVICE_RESULT_H
...
#endif // BLOCKWORLDS_COMPONENTS_VPNDETECTION_VPN_SERVICE_RESULT_H
