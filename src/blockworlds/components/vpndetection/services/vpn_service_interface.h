#ifndef BLOCKWORLDS_COMPONENTS_VPNDETECTION_SERVICES_VPN_SERVICE_INTERFACE_H
#define BLOCKWORLDS_COMPONENTS_VPNDETECTION_SERVICES_VPN_SERVICE_INTERFACE_H
...
#endif // BLOCKWORLDS_COMPONENTS_VPNDETECTION_SERVICES_VPN_SERVICE_INTERFACE_H
