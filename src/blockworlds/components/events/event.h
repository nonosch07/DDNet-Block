#ifndef GAME_SERVER_BLOCKWORLDS_COMPONENTS_EVENTS_EVENT_H
#define GAME_SERVER_BLOCKWORLDS_COMPONENTS_EVENTS_EVENT_H
...
#endif // GAME_SERVER_BLOCKWORLDS_COMPONENTS_EVENTS_EVENT_H
