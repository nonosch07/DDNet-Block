...
bool CCollision::TileExists(int Index) const
{
	...
	if((m_pTiles[Index].m_Index >= TILE_BW_VIP && m_pTiles[Index].m_Index <= TILE_BW_VIP) || (m_pFront && (m_pFront[Index].m_Index >= TILE_BW_VIP && m_pFront[Index].m_Index <= TILE_BW_VIP)))
		return true;
	if((m_pTiles[Index].m_Index >= TILE_BW_PASSIVE && m_pTiles[Index].m_Index <= TILE_BW_VIP) || (m_pFront && (m_pFront[Index].m_Index >= TILE_BW_PASSIVE && m_pFront[Index].m_Index <= TILE_BW_VIP)))
		return true;
