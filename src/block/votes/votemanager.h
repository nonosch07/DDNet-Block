// New Block voting system with page-based menus and safe, internal actions.
#ifndef BLOCK_VOTES_VOTEMANAGER_H
#define BLOCK_VOTES_VOTEMANAGER_H
...
#endif // BLOCK_VOTES_VOTEMANAGER_H
