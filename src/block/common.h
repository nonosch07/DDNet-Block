...
static constexpr int BLOCK_CLAN_NAME_MAX_LENGTH = 11; // max bytes of content (matches MAX_CLAN_LENGTH - 1)
static constexpr int BLOCK_CLAN_NAME_BUFFER_SIZE = 12; // equals MAX_CLAN_LENGTH

// Block game tiles. These sit above upstream's tile indices, so they can
