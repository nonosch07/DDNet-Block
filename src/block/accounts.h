#ifndef BLOCK_ACCOUNTS_H
#define BLOCK_ACCOUNTS_H
...
public:
	...
	/// Creates the account tables if they are missing and fills in any column
	/// added after the database was first set up. Enqueue this before any other
	/// account query; the pool keeps its queue in order.
	void EnsureSchema();
