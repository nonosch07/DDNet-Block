#ifndef BLOCK_COMPONENTS_REQUESTS_H
#define BLOCK_COMPONENTS_REQUESTS_H
...
class CRequests : public CComponent
{
	...
	struct SRequest
	{
		...
		char m_aOldClanName[BLOCK_CLAN_NAME_BUFFER_SIZE]{}; // for ClanRenameNotice
		char m_aNewClanName[BLOCK_CLAN_NAME_BUFFER_SIZE]{}; // for ClanRenameNotice
...
#endif // BLOCK_COMPONENTS_REQUESTS_H
