#ifndef BLOCK_COMPONENTS_EVENTS_COLORSOLDIERS_H
#define BLOCK_COMPONENTS_EVENTS_COLORSOLDIERS_H
...
{
public:
	explicit CColorSoldiersEvent(CGameContext *pGameServer) :
...
#endif // BLOCK_COMPONENTS_EVENTS_COLORSOLDIERS_H
