#ifndef BLOCK_COMPONENTS_VPNDETECTION_SERVICES_IPQUERY_SERVICE_H
#define BLOCK_COMPONENTS_VPNDETECTION_SERVICES_IPQUERY_SERVICE_H
...
#endif // BLOCK_COMPONENTS_VPNDETECTION_SERVICES_IPQUERY_SERVICE_H
