#ifndef BLOCK_COMPONENTS_VPNDETECTION_SERVICES_VPN_SERVICE_INTERFACE_H
#define BLOCK_COMPONENTS_VPNDETECTION_SERVICES_VPN_SERVICE_INTERFACE_H
...
#endif // BLOCK_COMPONENTS_VPNDETECTION_SERVICES_VPN_SERVICE_INTERFACE_H
