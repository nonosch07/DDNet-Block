#ifndef BLOCK_COMPONENTS_VPNDETECTION_SERVICES_PROXYCHECK_SERVICE_H
#define BLOCK_COMPONENTS_VPNDETECTION_SERVICES_PROXYCHECK_SERVICE_H
...
#endif // BLOCK_COMPONENTS_VPNDETECTION_SERVICES_PROXYCHECK_SERVICE_H
