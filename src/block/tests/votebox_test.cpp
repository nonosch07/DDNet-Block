...
class BlockVoteBox : public ::testing::TestWithParam<const char *> // NOLINT(readability-identifier-naming)
{
};

TEST_P(BlockVoteBox, BordersFitAndAlign)
{
...
INSTANTIATE_TEST_SUITE_P(Titles, BlockVoteBox,
	::testing::Values(
		"Block Menu",
		"Server Votes",
		"Rules",
...
TEST(BlockVoteBoxLabels, AnOptionLabelWithSmallCapsStillFits)
{
