#ifndef BLOCK_COSMETICS_CONTENT_H
#define BLOCK_COSMETICS_CONTENT_H
...
public:
	...
	void Snap(int SnappingClient) override
	{
		for(int i = 0; i < NUM; i++)
		{
			...
			GameServer()->Block().SnapLaserObject(CSnapContext(SnapVer, SixUp, SnappingClient), m_aIds[i], Pos, Pos, Server()->Tick() - 1, -1, LASERTYPE_GUN, -1, -1, LASERFLAG_NO_PREDICT);
		}
	}
...
#endif // BLOCK_COSMETICS_CONTENT_H
